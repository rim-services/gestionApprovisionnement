...
```html
<link rel="stylesheet" href="/design/owl.carousel/dist/assets/owl.carousel.min.css" />
```
...
```html
<script src="/design/jquery/dist/jquery.js"></script>
<script src="/design/owl.carousel/dist/owl.carousel.min.js"></script>
```
